...
switch ($_GET['page']) {
    ...
    //++echo $incCtrlr->getUserByName("isaac")->getnombrecompleto() . " " . $incCtrlr->getUserByName("isaac")->gettelefono(); 
    //require_once($incCtrlr->agregarArticulo($_GET["nombre completo"]) . ".php");
